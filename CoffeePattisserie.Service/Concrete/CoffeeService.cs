...
namespace CoffeePattisserie.Service.Concrete
{
    public class CoffeeService : ICoffeeService
    {
        ...
        public async Task<Response<NoContent>> DeleteAsync(int id)
        {
            ...
            if (coffee == null)
            {
                return Response<NoContent>.Fail("Böyle bir kahve bulunamadı", 404);
            }
        ...
        {
            List<Coffee> coffees = await _coffeeRepository.GetActiveCoffeesAsync(isActive);
            if (coffees.Count == 0)
            {
                return Response<List<CoffeeDto>>.Fail("İstediğiniz kriterde kahve bulunamadı", 404);
            }
        ...
        public async Task<Response<List<CoffeeDto>>> GetAllAsync()
        {
            ...
            if (coffees.Count == 0)
            {
                return Response<List<CoffeeDto>>.Fail("Hiç kahve bulunamadı", 404);
            }
            var coffeeDtos = _mapper.Map<List<CoffeeDto>>(coffees);
            return Response<List<CoffeeDto>>.Success(coffeeDtos, 200);
        }
        ...
        public async Task<Response<List<CoffeeDto>>> GetCoffeesByCategoryIdAsync(int categoryId)
        {
            ...
            if (coffees.Count == 0)
            {
                return Response<List<CoffeeDto>>.Fail("Bu kategoride hiç kahve bulunamadı", 404);
            }
            var coffeeDtos = _mapper.Map<List<CoffeeDto>>(coffees);
            return Response<List<CoffeeDto>>.Success(coffeeDtos, 200);
        }
        ...
        public async Task<Response<CoffeeDto>> GetByIdAsync(int id)
        {
            ...
            if (coffee == null)
            {
                return Response<CoffeeDto>.Fail("Böyle bir kahve bulunamadı", 404);
            }
        ...
        {
            List<Coffee> coffees = await _coffeeRepository.GetHomeCoffeesAsync();
            if (coffees.Count == 0)
            {
                return Response<List<CoffeeDto>>.Fail("İstediğiniz kriterde kahve bulunamadı", StatusCodes.Status404NotFound);
            }
            var coffeeDtos = _mapper.Map<List<CoffeeDto>>(coffees);
